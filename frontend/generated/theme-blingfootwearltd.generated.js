...
import stylesCss from 'themes/blingfootwearltd/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_blingfootwearltd_componentCss']) {
    
    document['_vaadintheme_blingfootwearltd_componentCss'] = true;
  }
