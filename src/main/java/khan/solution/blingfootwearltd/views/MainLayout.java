package khan.solution.blingfootwearltd.views;
 ...
 */
@PWA(name = "BlingFootWearLtd", shortName = "BlingFootWearLtd", enableInstallPrompt = false)
@Theme(themeFolder = "blingfootwearltd", variant = Lumo.DARK)
@PageTitle("Main")
